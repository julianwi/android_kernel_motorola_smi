...
int smd_qhd_amoled_cmd_reset(struct mdfld_dsi_config *dsi_config)
{
...
struct platform_driver smd_qhd_amoled_430_driver = {
	.probe	= smd_qhd_amoled_430_cmd_probe,
	.driver	= {
		.name	= "SMD QHD Amoled",
		.owner	= THIS_MODULE,
	},
