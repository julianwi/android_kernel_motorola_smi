...
static const struct lm3556_ctrl_id lm3556_ctrls[] = {
	s_ctrl_id_entry_integer(V4L2_CID_FLASH_TIMEOUT_COMPAT,
				"Flash Timeout",
				0,
				LM3556_MAX_TIMEOUT,
				1,
	...
	s_ctrl_id_entry_integer(V4L2_CID_FLASH_INTENSITY_COMPAT,
				"Flash Intensity",
				LM3556_MIN_PERCENT,
				LM3556_MAX_PERCENT,
				1,
	...
	s_ctrl_id_entry_integer(V4L2_CID_FLASH_TORCH_INTENSITY_COMPAT,
				"Torch Intensity",
				LM3556_MIN_PERCENT,
				LM3556_MAX_PERCENT,
				1,
	...
	s_ctrl_id_entry_integer(V4L2_CID_FLASH_INDICATOR_INTENSITY_COMPAT,
				"Indicator Intensity",
				LM3556_MIN_PERCENT,
				LM3556_MAX_PERCENT,
				1,
	...
	s_ctrl_id_entry_boolean(V4L2_CID_FLASH_STROBE_COMPAT,
				"Flash Strobe",
				0,
				0,
