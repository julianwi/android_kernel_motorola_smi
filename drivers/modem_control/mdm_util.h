...
void mdm_ctrl_set_opened(struct mdm_ctrl *drv, int value);
int mdm_ctrl_get_opened(struct mdm_ctrl *drv);

void mdm_ctrl_launch_work(struct mdm_ctrl *drv, int state);

void mdm_ctrl_set_state(struct work_struct *work);
int mdm_ctrl_get_state(struct mdm_ctrl *drv);
...
void mdm_ctrl_set_reset_ongoing(struct mdm_ctrl *drv, int ongoing);
int mdm_ctrl_get_reset_ongoing(struct mdm_ctrl *drv);
