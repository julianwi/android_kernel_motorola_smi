...
/* Manufacturing extensions */
#define ATOMISP_IOC_G_FACTORY_MODULE_INFO \
	_IOR('v', BASE_VIDIOC_PRIVATE + 100, struct atomisp_factory_module_info)

#define ATOMISP_IOC_S_FACTORY_TARGET_EXPOSURE \
	_IOW('v', BASE_VIDIOC_PRIVATE + 101, int)

#define ATOMISP_IOC_S_FACTORY_UNITY_GAMMA \
	_IOW('v', BASE_VIDIOC_PRIVATE + 102, int)

#define ATOMISP_IOC_S_FACTORY_DISABLE_EE \
	_IOW('v', BASE_VIDIOC_PRIVATE + 103, int)

#define ATOMISP_IOC_S_FACTORY_DISABLE_LSC \
...
#define V4L2_CID_FLASH_INTENSITY_COMPAT           (V4L2_CID_CAMERA_LASTP1 + 4)
...
#define V4L2_CID_FLASH_TORCH_INTENSITY_COMPAT     (V4L2_CID_CAMERA_LASTP1 + 6)
/* Indicator intensity, in percentage. */
#define V4L2_CID_FLASH_INDICATOR_INTENSITY_COMPAT (V4L2_CID_CAMERA_LASTP1 + 7)
/* Flash timeout (in ms). */
#define V4L2_CID_FLASH_TIMEOUT_COMPAT             (V4L2_CID_CAMERA_LASTP1 + 8)
/* Enable (1) or disable (0) the flash (only valid in FLASH mode). */
#define V4L2_CID_FLASH_STROBE_COMPAT              (V4L2_CID_CAMERA_LASTP1 + 9)
...
/* sensor test pattern */
#define V4L2_CID_TEST_PATTERN_COMPAT              (V4L2_CID_CAMERA_LASTP1 + 13)
